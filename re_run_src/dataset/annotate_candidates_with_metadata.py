...
def annotate_candidates_with_metadata(config: dict) -> None:
    ...
    input_train_file = os.path.join(config["input_dir"], "train.json")
    input_valid_file = os.path.join(config["input_dir"], "valid.json")
    ...
    train_save_path = os.path.join(config["save_dir"], config["save_train_filename"])
    valid_save_path = os.path.join(config["save_dir"], config["save_valid_filename"])
