...
| --- | --- | --- | --- | --- | --- | --- |
| SelfPaly | 0.0228 | 0.0789 | 0.1266 | **0.0870** | 0.0140 | 0.022 |
...
| --- | --- | --- | --- | --- | --- | --- |
| SelfPaly | 0.0141 | 0.0450 | 0.0968 | **0.0623** | 0.0158 | 0.028 |
...
| clusterin_high | 0.0129 | 0.0435 | **0.1032** | 0.0850 | 0.0165 | 0.028 |
| clusterout_low | 0.0129 | 0.0436 | 0.1026 | 0.0648 | **0.0230** | **0.039** |
